...
public class SqlQueryConstant {
    ...
    public static final String REMOVE_GYM_SLOT_QUERY="DELETE FROM slot WHERE id=?";

    public static final String SAVE_PAYMENT = "INSERT INTO payments (customerID, amount, isSuccessful,upiID) VALUES (?, ?,1,?)";
